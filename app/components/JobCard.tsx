...
export const JobCard = ({ title, description, company, logoLink, location }: JobCardProps) => {
    return (
        <div className='flex flex-col max-w-9/12 border-1 border-gray-300 rounded-3xl px-5 py-5'>
            <div className='flex gap-4'>
                ...
                <div className={`${epilogue.className}`}>
                    ...
                    <p className='text-base text-gray-400'>{company} <span className='mx-1 text-lg font-semibold'>•</span> {location}</p>
